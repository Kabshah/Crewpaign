...
# # crew.py file ke end mein yeh rakho:
...
#     nest_asyncio.apply()
    ...
    # This allows the crew to still be run directly if needed
    # inputs = {
    ...
    #     print("✅ Marketing crew completed successfully!")
    #     print(result)
    # except Exception as e:
    #     print(f"⚠️ Crew failed with error: {e}")




# purana working wala code
...
# except Exception as e:
#     print("⚠️ Crew failed with error:", e)
# finally:
#         print("✅ Marketing crew process finished (success ya fail dono ho sakta hai).")